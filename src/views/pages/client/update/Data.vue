        ...
        <div class="vx-row match-height">
            <div class="vx-col w-full sm:w-1/3 md:w-1/3 mb-base">
                <vx-card title="Datos de Cliente" noShadow>
                    ...
                    <div class="mb-3">
                        <vs-input type="email" name="email" label="Correo electrónico" v-model="form.email" v-validate="'email'" data-vv-validate-on="blur" />
                    ...
                    <div class="mb-3">
                        <vs-input type="text" name="tax_number" label="CIF/NIF" v-model="form.tax_number" v-validate="'required'" data-vv-validate-on="blur" />
            ...
            <div class="vx-col w-full sm:w-1/3 md:w-1/3 mb-base">
                <vx-card title="Datos de Contacto" noShadow>
                    ...
                    <div class="mb-3">
                        <vs-input type="email" name="contact_email" label="Correo electrónico" v-model="form.contact_email" v-validate="'email'" data-vv-validate-on="blur" />
